                    ...
                    <div class="card h-100">
                        <div class="nk-ecwg nk-ecwg2">
                            ...
                            <div class="nk-ecwg2-ck"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                <canvas class="ecommerce-bar-chart-s1 chartjs-render-monitor" id="averargeOrder" width="479" height="182" style="display: block; width: 479px; height: 182px;"></canvas>
                            </div>
                        </div><!-- .nk-ecwg -->
                    </div><!-- .card -->
                </div><!-- .col -->
                            ...
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg3">
                                    ...
                                    <div class="nk-ecwg3-ck"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas class="ecommerce-line-chart-s1 chartjs-render-monitor" id="totalOrders" width="479" height="66" style="display: block; width: 479px; height: 66px;"></canvas>
                                    </div>
                                </div><!-- .nk-ecwg -->
                            </div><!-- .card -->
                        </div><!-- .col -->
                        <div class="col-xxl-12 col-md-6">
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg3">
                                    ...
                                    <div class="nk-ecwg3-ck"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas class="ecommerce-line-chart-s1 chartjs-render-monitor" id="totalCustomers" width="479" height="66" style="display: block; width: 479px; height: 66px;"></canvas>
                                    </div>
                                </div><!-- .nk-ecwg -->
                            </div><!-- .card -->
                        </div><!-- .col -->
